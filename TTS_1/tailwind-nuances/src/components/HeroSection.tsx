        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6">
                    Designing <span className="text-brand-yellow">success.</span>
                </h1>
                <p className="text-xl md:text-2xl text-gray-400 mb-10 font-light max-w-2xl">
                    Over <span className="text-white font-semibold">1.5 billion</span> raised with the help of our products.
                </p>
